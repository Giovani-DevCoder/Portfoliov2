...
return (
  ...
  >
    <div className="overflow-hidden">
      <div className="px-4 py-4 rounded-lg bg-zinc-200/90 border border-zinc-200/90 transition-all duration-200 hover:bg-zinc-200/80 cursor-pointer">
        <div className="space-y-3">
          
          <div className="flex items-center justify-between gap-2">
            <span className="text-sm font-medium text-zinc-800">{experience.duration}</span>
            <FiExternalLink className="text-zinc-800" />
          </div>
